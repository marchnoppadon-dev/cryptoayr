...
export const metadata = {
  title: "บอทเทรด Forex (EA) คืออะไร | cryptoayr",
  description: "ทำความรู้จัก EA (Expert Advisor) บอทเทรดอัตโนมัติสำหรับ Forex ทำงานอย่างไร และสิ่งที่ควรระวังก่อนใช้",
};
    ...
    <div style={{ background: COLORS.bg, color: COLORS.text, minHeight: "100vh" }} className={thai.className}>
      ...
      <div style={{ padding: "2.5rem 2rem", maxWidth: 760, margin: "0 auto" }}>
        <nav style={{ fontSize: 12, color: COLORS.muted, marginBottom: "1rem" }}>
          ...
          <Link href="/forex" style={{ color: COLORS.muted }}>Forex</Link> / บอทเทรด Forex
        </nav>
        ...
        {article ? (
          <>
            ...
            {/* TODO: จุดใส่ affiliate link บอทเทรด/EA Forex - รอตัดสินใจ partner ก่อน */}
            <div style={{ background: COLORS.surf, border: "1px dashed " + COLORS.border, borderRadius: 10, padding: 24, marginTop: 32, textAlign: "center" }}>
              <p style={{ color: COLORS.muted, fontSize: 13, margin: 0 }}>
                (พื้นที่สำหรับลิงก์แนะนำ EA/บอทเทรด affiliate — จะเพิ่มภายหลัง)
              </p>
            </div>
          </>
        ) : (
